...
namespace UnityStandardAssets.Utility
{
	public class CustomHandles
	{
		...
		public static Vector3 DragHandle(Vector3 position, Quaternion direction, float handleSize, Handles.DrawCapFunction capFunc, Color colorSelected, out DragHandleResult result)
		{
			...
			switch (Event.current.GetTypeForControl(id))
			{
				...
				case EventType.Repaint:
					...
					capFunc(id, screenPosition, direction, handleSize);
